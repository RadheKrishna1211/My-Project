...
class ScanStudentResultPageGame3:
    ...
    def calculate_score(self):
        ...
        for row in self.final_result:
            print("row", row)
            print("original", self.exercise_questions[i][7])
            if row == self.exercise_questions[i][7]:
    ...
    def insert_result_data(self):
        ...
        for row in self.final_result:
            print("row", row)
            db.insert_result_for_student(self.student_id,self.teacher_id,self.exercise_id,self.exercise_questions[i][0],self.exercise_questions[i][1],str(row),str(self.exercise_questions[i][7]))
            print("original", self.exercise_questions[i][7])     
            i=i+1
